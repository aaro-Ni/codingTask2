...
describe('bundle builder v2', () => {
  ...
  it('should able to handle fixed bundle price', () => {
    const result = productDiscounts({
      "cart": {
        "buyerIdentity": null,
        "lines": [
      ...
      "discountNode": {
        "metafield": {
          "value": JSON.stringify({
            "id": "148",
            "tiers": [
              { "title": "3 FRUITS - 20 euros", "amount": 20, "quantity": 3 },
              { "title": "6 FRUITS - 30 euros", "amount": 30, "quantity": 6 },
              { "title": "9 FRUITS - 40 euros", "amount": 40, "quantity": 9 }
            ],
            "collections": [],
            "products": [
              "gid://shopify/Product/Apple",
